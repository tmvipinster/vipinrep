...
@synthesize isLongPressed =_isLongPressed;
...
- (void)layoutSubviews
{
    ...
    if (_selected || _highlighted) {
        ...
        _contentView.backgroundColor = _userContentViewBackgroundColor ?
                                       _userContentViewBackgroundColor : [UIColor clearColor];
...
- (void)_layoutAccessories
{
    ...
    dispatch_once(&onceToken, ^{
        ...
        normalBadges[KKGridViewCellAccessoryTypeBadgeNumeric] = [UIImage imageNamed:@"add_shortcut.png"];
        normalBadges[KKGridViewCellAccessoryTypeNew] = [UIImage imageNamed:@"new_item.png"];
        ...
        pressedBadges[KKGridViewCellAccessoryTypeBadgeNumeric] = [UIImage imageNamed:@"add_shortcut.png"];
         pressedBadges[KKGridViewCellAccessoryTypeNew] = [UIImage imageNamed:@"new_item.png"];
    });
    ...
    [_badgeView addTarget:self action:@selector(onBadgePress) forControlEvents:UIControlEventTouchUpInside];
    ...
    {
       //TBD: Findout the right solution for this values
        w = h = 72.0;
    }
    ...
    if(self.isLongPressed)
    {
        (void)pointMap[KKGridViewCellAccessoryPositionCenter];
        _badgeView.frame = (CGRect){pointMap[KKGridViewCellAccessoryPositionCenter], {s-o, s-o}};
    }
    else
    {
