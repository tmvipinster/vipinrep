...
- (void)refreshData
{
    ...
    [fieldsDictionnary setObject:[NSNumber numberWithInt:(int)(self.currentPage * self.numberOfItemsPerPage)] forKey:@"limit"];
    [fieldsDictionnary setObject:[NSNumber numberWithInt:(int)((self.currentPage - 1) * self.numberOfItemsPerPage)] forKey:@"offset"];
